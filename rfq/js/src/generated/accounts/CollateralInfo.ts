...
export class CollateralInfo implements CollateralInfoArgs {
  ...
  static fromArgs(args: CollateralInfoArgs) {
    return new CollateralInfo(args.bump, args.user, args.tokenAccountBump, args.lockedTokensAmount);
  }
   ...
   */
  static fromAccountInfo(accountInfo: web3.AccountInfo<Buffer>, offset = 0): [CollateralInfo, number] {
  ...
  static async getMinimumBalanceForRentExemption(
    ...
    return connection.getMinimumBalanceForRentExemption(CollateralInfo.byteSize, commitment);
  }
