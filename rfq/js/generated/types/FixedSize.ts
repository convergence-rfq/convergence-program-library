...
export const isFixedSizeNone = (
  x: FixedSize
): x is FixedSize & { __kind: 'None' } => x.__kind === 'None'
export const isFixedSizeBaseAsset = (
  x: FixedSize
): x is FixedSize & { __kind: 'BaseAsset' } => x.__kind === 'BaseAsset'
export const isFixedSizeQuoteAsset = (
  x: FixedSize
): x is FixedSize & { __kind: 'QuoteAsset' } => x.__kind === 'QuoteAsset'
