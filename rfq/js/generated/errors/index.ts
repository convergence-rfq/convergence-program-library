...
createErrorFromCodeLookup.set(0x1778, () => new NotEnoughCollateralError())
createErrorFromNameLookup.set(
  'NotEnoughCollateral',
...
createErrorFromCodeLookup.set(0x177a, () => new NotEnoughAccountsError())
createErrorFromNameLookup.set(
  'NotEnoughAccounts',
...
createErrorFromCodeLookup.set(0x177c, () => new RfqIsNotInRequiredStateError())
createErrorFromNameLookup.set(
...
createErrorFromCodeLookup.set(0x177e, () => new InvalidQuoteTypeError())
createErrorFromNameLookup.set(
  'InvalidQuoteType',
...
createErrorFromCodeLookup.set(0x177f, () => new ResponseForAnotherRfqError())
createErrorFromNameLookup.set(
...
createErrorFromCodeLookup.set(0x1780, () => new NotATakerError())
...
createErrorFromCodeLookup.set(0x1782, () => new ConfirmedSideMissingError())
createErrorFromNameLookup.set(
...
createErrorFromCodeLookup.set(0x1783, () => new NotAPassedAuthorityError())
createErrorFromNameLookup.set(
  'NotAPassedAuthority',
...
createErrorFromCodeLookup.set(0x1784, () => new TakerCanNotRespondError())
createErrorFromNameLookup.set(
  'TakerCanNotRespond',
...
createErrorFromCodeLookup.set(0x1785, () => new NotAQuoteMintError())
...
createErrorFromCodeLookup.set(0x1786, () => new WrongQuoteReceiverError())
createErrorFromNameLookup.set(
  'WrongQuoteReceiver',
...
createErrorFromCodeLookup.set(0x178a, () => new NoPreparationToRevertError())
createErrorFromNameLookup.set(
...
createErrorFromCodeLookup.set(0x178b, () => new NoCollateralLockedError())
createErrorFromNameLookup.set(
  'NoCollateralLocked',
...
createErrorFromCodeLookup.set(0x178c, () => new InvalidDefaultingPartyError())
createErrorFromNameLookup.set(
...
createErrorFromCodeLookup.set(0x178d, () => new HaveCollateralLockedError())
createErrorFromNameLookup.set(
...
createErrorFromCodeLookup.set(0x178e, () => new PendingPreparationsError())
createErrorFromNameLookup.set(
  'PendingPreparations',
...
createErrorFromCodeLookup.set(0x178f, () => new InvalidBackupAddressError())
createErrorFromNameLookup.set(
...
createErrorFromCodeLookup.set(0x1790, () => new NotAMakerError())
...
createErrorFromCodeLookup.set(0x1791, () => new NotFirstToPrepareError())
createErrorFromNameLookup.set(
  'NotFirstToPrepare',
...
createErrorFromCodeLookup.set(0x1792, () => new HaveExistingResponsesError())
createErrorFromNameLookup.set(
