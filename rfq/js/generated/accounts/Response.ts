...
export type ResponseArgs = {
  ...
  takerPreparedToSettle: boolean
  makerPreparedToSettle: boolean
  confirmed: beet.COption<Confirmation>
  defaultingParty: beet.COption<DefaultingParty>
  firstToPrepare: beet.COption<AuthoritySide>
...
export class Response implements ResponseArgs {
  private constructor(
    ...
    readonly takerPreparedToSettle: boolean,
    readonly makerPreparedToSettle: boolean,
    readonly confirmed: beet.COption<Confirmation>,
    readonly defaultingParty: beet.COption<DefaultingParty>,
    readonly firstToPrepare: beet.COption<AuthoritySide>,
  ...
  static fromArgs(args: ResponseArgs) {
    return new Response(
      ...
      args.state,
      args.takerPreparedToSettle,
      args.makerPreparedToSettle,
      args.confirmed,
  ...
  pretty() {
    return {
      ...
      takerPreparedToSettle: this.takerPreparedToSettle,
      makerPreparedToSettle: this.makerPreparedToSettle,
...
>(
  [
    ...
    ['takerPreparedToSettle', beet.bool],
    ['makerPreparedToSettle', beet.bool],
    ['confirmed', beet.coption(confirmationBeet)],
    ['defaultingParty', beet.coption(defaultingPartyBeet)],
    ['firstToPrepare', beet.coption(authoritySideBeet)],
