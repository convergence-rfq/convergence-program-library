...
use crate::constants::{OPERATOR_COUNTERPARTY_FEE_PROPORTION, OPERATOR_CREATOR_FEE_PROPORTION};
...
pub fn sign_print_trade<'info>(
    ...
    // let side = to_hxro_side(AuthoritySide::Maker);
    ...
    //     user: ctx.accounts.maker.to_account_info(),
    ...
    // dex::cpi::sign_print_trade(context, params)
}
