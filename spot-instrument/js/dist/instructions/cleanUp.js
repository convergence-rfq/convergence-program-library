...
exports.cleanUpStruct = new beet.BeetArgsStruct([
    ['instructionDiscriminator', beet.uniformFixedSizeArray(beet.u8, 8)],
    ['legIndex', beet.u8],
], 'CleanUpInstructionArgs');
exports.cleanUpInstructionDiscriminator = [
    8, 182, 195, 138, 85, 137, 221, 250,
];
function createCleanUpInstruction(accounts, args, programId = new web3.PublicKey('826r9RA3AGHPas5E4DgbN9MpYa8gE2ZDUPUJW6GEZ3cT')) {
    var _a;
    ...
    const keys = [
        ...
        {
            pubkey: accounts.backupReceiver,
            isWritable: true,
            isSigner: false,
        },
        {
