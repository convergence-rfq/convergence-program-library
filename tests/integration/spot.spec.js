...
describe("RFQ Spot instrument integration tests", () => {
    ...
    it("Create two-way RFQ with one spot leg, respond and settle as sell", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const rfq = yield context.createRfq({
            legs: [spotInstrument_1.SpotInstrument.createForLeg(context, { amount: (0, helpers_1.withTokenDecimals)(1), side: types_1.Side.Bid })],
        });
    ...
    it("Create sell RFQ with two spot legs, respond and settle multiple responses", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const rfq = yield context.createRfq({
            legs: [
                spotInstrument_1.SpotInstrument.createForLeg(context, { amount: (0, helpers_1.withTokenDecimals)(5), side: types_1.Side.Bid }),
                spotInstrument_1.SpotInstrument.createForLeg(context, {
                    mint: context.additionalAssetToken,
                    amount: (0, helpers_1.withTokenDecimals)(1000),
        ...
        const response = yield rfq.respond({
            bid: types_1.Quote.getStandart((0, helpers_1.toAbsolutePrice)((0, helpers_1.withTokenDecimals)(70000)), (0, helpers_1.toLegMultiplier)(0.5)),
        });
        // respond with quote for twice of legs once more with higher price
        const secondResponse = yield rfq.respond({
            bid: types_1.Quote.getStandart((0, helpers_1.toAbsolutePrice)((0, helpers_1.withTokenDecimals)(71000)), (0, helpers_1.toLegMultiplier)(2)),
        });
        ...
        const firstMeasurer = yield helpers_1.TokenChangeMeasurer.takeSnapshot(context, ["asset", "quote", "additionalAsset"], [taker, maker]);
        yield response.prepareSettlement(types_1.AuthoritySide.Taker);
        yield response.prepareSettlement(types_1.AuthoritySide.Maker);
        ...
        yield firstMeasurer.expectChange([
            ...
            { token: "additionalAsset", user: taker, delta: (0, helpers_1.withTokenDecimals)(250) },
            { token: "additionalAsset", user: maker, delta: (0, helpers_1.withTokenDecimals)(-250) },
            { token: "quote", user: taker, delta: (0, helpers_1.withTokenDecimals)(17500) },
            { token: "quote", user: maker, delta: (0, helpers_1.withTokenDecimals)(-17500) },
        ]);
        yield response.unlockResponseCollateral();
        yield response.cleanUp();
        // taker confirms second response
        yield secondResponse.confirm({ side: types_1.Side.Bid });
        const secondMeasurer = yield helpers_1.TokenChangeMeasurer.takeSnapshot(context, ["asset", "quote", "additionalAsset"], [taker, maker]);
        ...
        yield secondMeasurer.expectChange([
            ...
            { token: "additionalAsset", user: taker, delta: (0, helpers_1.withTokenDecimals)(2000) },
            { token: "additionalAsset", user: maker, delta: (0, helpers_1.withTokenDecimals)(-2000) },
            { token: "quote", user: taker, delta: (0, helpers_1.withTokenDecimals)(142000) },
            { token: "quote", user: maker, delta: (0, helpers_1.withTokenDecimals)(-142000) },
        ]);
        yield secondResponse.unlockResponseCollateral();
        yield secondResponse.cleanUp();
    }));
    it("Create fixed leg size buy RFQ, respond and settle response", () => __awaiter(void 0, void 0, void 0, function* () {
        // create a buy RFQ specifying 15 bitcoin as a leg(5 in leg with multiplier of 3)
        const rfq = yield context.createRfq({
            legs: [spotInstrument_1.SpotInstrument.createForLeg(context, { amount: (0, helpers_1.withTokenDecimals)(5), side: types_1.Side.Bid })],
    ...
    it("Create fixed quote size sell RFQ, respond and settle response", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const rfq = yield context.createRfq({
            legs: [spotInstrument_1.SpotInstrument.createForLeg(context, { amount: (0, helpers_1.withTokenDecimals)(0.5), side: types_1.Side.Bid })],
    ...
    it("Create RFQ, respond and confirm, both parties default", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield rfq.cleanUp();
        yield tokenMeasurer.expectChange([
            { token: "unlockedCollateral", user: taker, delta: (0, helpers_1.withTokenDecimals)(-660) },
            { token: "unlockedCollateral", user: maker, delta: (0, helpers_1.withTokenDecimals)(-660) },
            { token: "unlockedCollateral", user: dao, delta: (0, helpers_1.withTokenDecimals)(1320) },
        ]);
    }));
    ...
    it("Create RFQ with a lot of spot legs and settle it", () => __awaiter(void 0, void 0, void 0, function* () {
        const legAmount = 6;
        const mints = yield Promise.all([...Array(legAmount)].map(() => __awaiter(void 0, void 0, void 0, function* () {
            const mint = yield wrappers_1.Mint.create(context);
            yield mint.register(constants_1.BITCOIN_BASE_ASSET_INDEX);
            return mint;
        })));
        const legs = mints.map((mint) => spotInstrument_1.SpotInstrument.createForLeg(context, {
            mint,
        }));
        const rfq = yield context.createRfq({
        ...
        yield rfq.addLegs(legs.slice(legAmount / 2), false);
        yield rfq.finalizeConstruction();
        const response = yield rfq.respond();
        yield response.confirm();
