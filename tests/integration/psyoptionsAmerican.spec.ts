import { BN, Spl, web3, Program } from "@project-serum/anchor";
...
import { programId } from "../dependencies/tokenized-euros/src/index";
import * as idl from "../../target/idl/psy_american.json";
...
// let provider = new anchor.AnchorProvider(rpc, payer, anchor.AnchorProvider.defaultOptions());

// let psyoptionsProgramId = new anchor.web3.PublicKey("R2y9ip6mxmWUj4pt54jP2hz2dgvMozy9VTSwMWE7ev");
// let psyoptionProgram = new anchor.Program(
//   psyoptionAmerican.PsyAmericanIdl,
//   psyoptionsProgramId,
//   provider
// ) as anchor.Program<psyoptionAmerican.PsyAmerican>;

describe("American psyoption integration tests for v2", async () => {
  let quoteMintPubkey = new anchor.web3.PublicKey("Dimn96obSSrX6hbJ8UiKkJXczRLaaaRZ1FbVyi2qoUku");
  let underlyingMintPubkey = new anchor.web3.PublicKey("E1eu6ZxV2VNKTi7M6ugsjiBQpyVFTQ1FQA5MqKiZ6KBn");
  let underlyingAmountPerContract = new anchor.BN("100000");
  let quoteAmountPerContract = new anchor.BN("5000");
  ...
  it("Option Market Initialization ...", async () => {
    // try {
    //   let ix = psyoptionAmerican.instructions.initializeMarket(
    //     psyoptionProgram as Program<psyoptionAmerican.PsyAmerican>,
    //     {
