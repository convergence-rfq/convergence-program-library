      ...
      accounts: [
        {
          ...
          isMut: true;
          isSigner: true;
          docs: ["The wallet address signing the transaction"];
        },
        {
          name: "stableMint";
          isMut: false;
          isSigner: false;
          docs: ["The mint of the stable asset"];
        },
        {
          name: "stablePool";
          isMut: true;
    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          isMut: false;
          isSigner: false;
          docs: ["The mint of the underlying asset. Calls will be settled in this asset."];
        },
        {
          name: "underlyingPool";
          isMut: true;
    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          isMut: false;
          isSigner: false;
          docs: ["The mint of the underlying asset"];
        },
        {
          name: "expirationData";
          isMut: true;
      ...
      type: {
        ...
        fields: [
          ...
          },
          {
            ...
            docs: ["The nubmer of decimals on the underlying, read from the Mint on creation"];
            type: "u8";
          },
          {
            name: "underlyingAmountPerContract";
            docs: ["The amount of underlying assets per 1 OptionToken,", "denoted in the underlying assets decimals."];
            type: "u64";
          },
          {
            name: "stableMint";
            docs: ["The mint key for some stable coin that is pegged to the oracle"];
            type: "publicKey";
          },
          {
            name: "stableDecimals";
            docs: ["The decimals of the stable mint"];
            type: "u8";
          },
          {
            name: "stablePool";
            docs: ["The stable pool's address"];
            type: "publicKey";
          },
          {
            name: "oracle";
            docs: ["The key for the oracle mapping"];
            type: "publicKey";
          },
          {
            name: "strikePrice";
            docs: ["The strike price with decimals price_decimals"];
            type: "u64";
          },
          {
            name: "priceDecimals";
          ...
          {
            name: "callOptionMint";
            docs: ["The mint for the CALL option tokens"];
            type: "publicKey";
          },
          {
            name: "callWriterMint";
            docs: ["The mint for the CALL writer tokens"];
            type: "publicKey";
          },
          {
            name: "putOptionMint";
            docs: ["The mint for the PUT option tokens"];
            type: "publicKey";
          },
          {
            name: "putWriterMint";
            docs: ["The mint for the PUT writer tokens"];
            type: "publicKey";
          },
          {
            name: "underlyingPool";
            docs: ["The TokenAccount that holds underlying asset deposits"];
            type: "publicKey";
          },
          {
            name: "expiration";
            docs: ["The Unix Timestamp for the expiration"];
            type: "i64";
          },
          {
            name: "bumpSeed";
            docs: ["The bump seed for the EuroMeta"];
            type: "u8";
          },
          {
            name: "expirationData";
          ...
          {
            name: "oracleProviderId";
            docs: ["An oracle provider identifier"];
            type: "u8";
          }
        ];
      };
    },
    {
      ...
      type: {
        ...
        fields: [
          {
            name: "expiration";
            docs: ["The expiration time"];
            type: "i64";
          },
          {
            name: "oracle";
            docs: ["The aggregate price oracle for pyth or switchboard"];
            type: "publicKey";
          },
          {
            name: "priceAtExpiration";
            docs: ["The price, in price_decimals, at the time of expiration"];
            type: "u64";
          },
          {
            name: "priceSetAtTime";
            docs: ["The time at which the price_at_expiration was set."];
            type: "i64";
          },
          {
            name: "priceDecimals";
          ...
          {
            name: "priceSet";
            docs: ["Flag for easy memcmp filtering"];
            type: "bool";
          },
          {
            name: "bump";
...
export const IDL: EuroPrimitive = {
  version: "0.1.0",
  name: "euro_primitive",
  instructions: [
    {
