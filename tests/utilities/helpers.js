...
exports.expandComputeUnits = exports.toLittleEndian = exports.TokenChangeMeasurer = exports.calculateLegsSize = exports.executeInParallel = exports.withTokenDecimals = exports.toLegMultiplier = exports.toAbsolutePrice = exports.sleep = exports.expectError = void 0;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const change of extendedChanges) {
                ...
                if (change.precision === undefined) {
                    ...
                    (0, chai_1.expect)(difference).to.be.bignumber.lessThan(change.precision, `Balance change differs from expected! Token: ${change.token.toString()}, user: ${change.user.toString()}, balance before: ${snapshot.balance.toString()}, balance currenty: ${change.currentBalance.toString()}, expected change: ${change.delta.toString()} with precision ${change.precision.toString()}`);
                }
            }
        });
    }
...
exports.expandComputeUnits = web3_js_1.ComputeBudgetProgram.setComputeUnitLimit({
    units: 1400000,
});
