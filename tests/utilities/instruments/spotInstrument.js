...
class SpotInstrument {
    ...
    static createForLeg(context, { mint = context.assetToken, amount = constants_1.DEFAULT_INSTRUMENT_AMOUNT, side = null } = {}) {
        const instrument = new SpotInstrument(context, mint);
        mint.assertRegistered();
        return new instrument_1.InstrumentController(instrument, { amount, side: side !== null && side !== void 0 ? side : constants_1.DEFAULT_INSTRUMENT_SIDE, baseAssetIndex: mint.baseAssetIndex }, mint.decimals);
    }
    static createForQuote(context, mint = context.assetToken) {
        const instrument = new SpotInstrument(context, mint);
        mint.assertRegistered();
        return new instrument_1.InstrumentController(instrument, null, mint.decimals);
    }
    static addInstrument(context) {
        return __awaiter(this, void 0, void 0, function* () {
            yield context.addInstrument(getSpotInstrumentProgram().programId, true, 1, 7, 3, 3, 4);
            yield context.riskEngine.setInstrumentType(getSpotInstrumentProgram().programId, types_1.InstrumentType.Spot);
        });
    }
    ...
    getPrepareSettlementAccounts(side, assetIdentifier, rfq, response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return [
                ...
                {
                    pubkey: yield yield spl_token_1.Token.getAssociatedTokenAddress(spl_token_1.ASSOCIATED_TOKEN_PROGRAM_ID, spl_token_1.TOKEN_PROGRAM_ID, this.mint.publicKey, caller.publicKey),
                    isSigner: false,
                    isWritable: true,
                },
